...
DEPLOY_SCRIPT="$RELEASE_ROOT/scripts/deploy-1.9.29-vps.sh"
UNIT_PREFIX="kalpavriksha-deploy-1929"
...
echo
echo "Kalpavriksha 1.9.29 deployment started independently of SSH."
