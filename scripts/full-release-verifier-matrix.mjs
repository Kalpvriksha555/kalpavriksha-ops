...
const steps = [
  ...
  { id:'frontend-runtime-shapes', label:'Frontend runtime shape contracts', args:['scripts/phase-11-frontend-runtime-shape-check.mjs'] },
  { id:'api-contract-stale-responses', label:'API contract and stale response closure', args:['scripts/phase-12-api-contract-stale-response-check.mjs'] },
  { id:'task-lifecycle-idempotency', label:'Task lifecycle and idempotency closure', args:['scripts/phase-13-task-lifecycle-idempotency-check.mjs'] },
  { id:'file-upload-preview-retention', label:'File upload, preview and retention closure', args:['scripts/phase-14-file-upload-preview-retention-check.mjs'] },
  { id:'auth-session-browser-isolation', label:'Authentication, session and multi-user browser closure', args:['scripts/phase-15-auth-session-browser-isolation-check.mjs'] },
  { id:'attendance-presence-live-sync', label:'Attendance, presence and live-sync closure', args:['scripts/phase-16-attendance-presence-live-sync-check.mjs'] },
  { id:'finance-ledger-invariants', label:'Finance, reports and ledger invariants closure', args:['scripts/phase-17-finance-ledger-invariants-check.mjs'] },
  { id:'runtime-persistence-restart', label:'PostgreSQL runtime persistence and restart closure', args:['scripts/phase-18-runtime-persistence-restart-check.mjs'] },
  { id:'performance-memory-long-session', label:'Performance, memory and long-session closure', args:['scripts/phase-19-performance-memory-long-session-check.mjs'] },
  { id:'runtime-error-diagnostics', label:'Runtime error diagnostics and self-diagnosing failure closure', args:['scripts/phase-20-runtime-error-diagnostics-check.mjs'] },
  { id:'resume-aware-atomic-deployment', label:'Resume-aware deployment, atomic cutover and rollback closure', args:['scripts/phase-21-resume-aware-deployment-check.mjs'] },
  { id:'end-to-end-fault-matrix-final-soak', label:'End-to-end fault matrix and final stability soak', args:['scripts/phase-22-end-to-end-fault-soak-check.mjs'] },
  { id:'production-local-postgres-certification', label:'Production-local PostgreSQL certification compatibility closure', args:['scripts/phase-23-production-local-postgres-certification-check.mjs'] },
  { id:'operator-safe-certify-deploy', label:'SSH-independent final certification and operator deployment closure', args:['scripts/phase-24-operator-safe-certify-deploy-check.mjs'] },
